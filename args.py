...
def get_parser():
    parser = argparse.ArgumentParser(description='CADFormer training and testing')
    ...
    parser.add_argument('--model_id', default='CADFormer', help='name to identify the model')
